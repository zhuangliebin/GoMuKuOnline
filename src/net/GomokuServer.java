...
public class GomokuServer {
	...
	public static List<SocketChannel> socketChannels=new ArrayList<SocketChannel>();
...
//						ByteBuffer byteBuffer=ByteBuffer.allocate("sd".length());
//						byteBuffer.put("sd".getBytes());
//						byteBuffer.flip();
//						socketChannels.get(0).write(byteBuffer);
//						byteBuffer.clear();
						int bytesEchoed = 0;
